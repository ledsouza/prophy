                ...
                <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                    <div className="text-center">
                        ...
                        <div className="mt-10 flex items-center justify-center gap-x-6">
                            <Link
                                href={authRedirect}
                                className="rounded-md bg-primary px-3.5 py-2.5 text-sm font-semibold text-text-quaternary shadow-sm hover:bg-secondary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-tertiary"
                            >
                                Acesse a sua conta
                            </Link>
                        </div>
