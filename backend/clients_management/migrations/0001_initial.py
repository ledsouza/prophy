    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('I', 'Presencial'), ('O', 'Online')], default='I', max_length=1, verbose_name='Tipo')),
                ('status', models.CharField(choices=[('P', 'Pendente'), ('C', 'Confirmado'), ('F', 'Realizado'), ('U', 'Não realizado'), ('R', 'Reagendada')], default='P', max_length=1, verbose_name='Status')),
                ('justification', models.TextField(blank=True, null=True, verbose_name='Justificativa')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contract_type', models.CharField(choices=[('A', 'Anual'), ('M', 'Mensal'), ('W', 'Semanal')], max_length=1, verbose_name='Tipo de contrato')),
                ('pdf_version', models.FileField(upload_to='proposals/pdfs/')),
                ('word_version', models.FileField(upload_to='proposals/words/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updates', models.TextField(blank=True, null=True, verbose_name='Atualização')),
            ],
        ),
        migrations.CreateModel(
            name='Unit',
