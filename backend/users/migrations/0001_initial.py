    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('FMI', 'Físico Médico Interno'), ('FME', 'Físico Médico Externo'), ('GP', 'Gerente Prophy'), ('GGC', 'Gerente Geral de Cliente'), ('GU', 'Gerente de Unidade'), ('C', 'Comercial'), ('SA', 'Conta de Serviço')], default='GGC', max_length=30, verbose_name='Perfil')),
